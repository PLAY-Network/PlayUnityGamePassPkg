...
namespace RGN.MyEditor
{
    ...
    {
        private const string PackagesFolderPath = "Packages/io.getready.rgn.gamepass";
        private const string DestinationLinkPath = "Assets/ReadyGamesNetwork/Linker/RGNGamePass";
        ...
        {
            Debug.Log("[RGNImplFirebase] Build PreProcessor");
